...
proxima:
    ...
    ' ADR-050: da atribuicao de RUN ate a tela atualizada, uma operacao so
    mApp.InicioUsuario "Registrando " & nReg & " resultado(s)..."
    On Error GoTo falhaGrav
    ...
    mAuditoria.RegistrarLog "IMPORTACAO_ABA", nReg & " resultados"
    ...
    Exit Function
falhaGrav:
    Dim nEg As Long, sEg As String
    nEg = Err.Number: sEg = Err.Description
    mApp.Fim
    Err.Raise nEg, "mImportar.ExecutarImportacao", sEg
End Function
