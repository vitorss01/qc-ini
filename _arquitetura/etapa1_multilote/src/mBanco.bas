...
' 19/09/2026 (ADR-050): 150.000. O teste de cinco anos no cenario PESADO (20
' lotes, 1 corrida por dia util + 2a corrida em 40% dos dias, 31 analitos x 2
' niveis) chegou a 115.196 linhas -- 4% de folga no teto antigo. Com o banco
' sem formula e o motor indexado, o teto nao custa desempenho; so precisa
' existir e recusar com mensagem.
Public Const CAP_LINHAS As Long = 150000
...
' Involucro de teste para a barreira.
'
...
Public Sub AtualizarFlagsBanco()
    ...
    If ult < BANCO_R0 Then mLotes.AtualizarListaLiberacao Empty: Exit Sub
    ...
    ' ADR-050: a lista de corridas da Liberacao era formula sobre o banco
    ' inteiro; agora e valor, refeito aqui -- toda gravacao e toda exclusao
    ' passam por esta rotina. Reaproveita a matriz ja lida.
    mLotes.AtualizarListaLiberacao dados
End Sub
