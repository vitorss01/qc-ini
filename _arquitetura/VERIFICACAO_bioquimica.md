...
**Executada em:** 04/08/2026 21:37:07
...
| 2.1 | AtualizarPainelEng | OK | 0,04s |
| 2.1 | AtualizarEstatisticaAba | OK | 0,05s |
| 2.1 | RegistrarEventosWestgard | OK | 0,04s |
...
| 3.11 | as duas camadas compartilham o ID_Auditoria | OK | banco='AUD-000005-20260804213322' evento='AUD-000005-20260804213322' |
...
| 3.15 | as tres camadas registram com o mesmo ID | OK | ID: 'AUD-000006-20260804213324' | log do banco: 1 -> 2 |
...
| 4b.1 | motor completo abaixo de 5s | OK | 0,25s para as 4 rotinas sobre 1.575 registros |
| 4b.2 | gravacao em camada dupla abaixo de 250ms por evento | OK | 232ms por evento (11,6s para 50 eventos nas duas camadas) |
| 4b.3 | verificacao da cadeia integra e rapida | OK | OK|59 em 0,24s |
| 2.2 | valor ORIGINAL recuperavel no Audit_Log | OK | OK|92,0028 |
| 1.6 | nenhum nome publico duplicado entre modulos | OK | 109 nomes publicos, nenhum repetido |
...
| 5.6 | usuario nao consegue criar aba (estrutura travada) | OK | ` |
