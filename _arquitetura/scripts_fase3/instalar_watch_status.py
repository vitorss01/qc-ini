...
HANDLER = [
    ...
    "    ' Vigia o REGISTRO inteiro (A:G), nao so o Status. Apagar A:G de uma",
    "    ' linha deixava BA:BC orfas -- linha sem RUN com BC=1 faz o AGREGAR da",
    "    ' Liberacao enxergar uma corrida ZERO e deslocar a lista toda.",
    "    Set inter = Application.Intersect(Target, _",
    "                Me.Range(Me.Columns(COL_RUN), Me.Columns(COL_STATUS)))",
    "    On Error GoTo 0",
